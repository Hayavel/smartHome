...
"}")
        ...
        self.whiteRound_white.setPixmap(QPixmap(u"coldWarm.png"))
...
"")
        ...
        self.rgb.setPixmap(QPixmap(u"rgb.png"))
...
"")
        ...
        icon = QIcon()
        icon.addFile(u"../../SmartBulb/design/trash.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.active_scene.setPixmap(QPixmap(u"icon.png"))
...
"")
        icon2 = QIcon()
        icon2.addFile(u"modeOFF.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.whiteRound_Light.setPixmap(QPixmap(u"coldWarm.png"))
...
"}")
        icon3 = QIcon()
        icon3.addFile(u"menu.png", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        self.brightSlider_Light.valueChanged.connect(self.brightBar_Light.setValue)
